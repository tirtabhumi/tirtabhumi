    ...
    <section class="pt-32 pb-24 bg-[#eef2f6] min-h-screen">
        <div class="container mx-auto px-6">
            ...
            <div class="mb-12 flex justify-center">
                <form action="{{ route('blog.index') }}" method="GET" class="relative w-full md:w-[60%] flex items-center rounded-full neu-pressed bg-[#eef2f6] px-6">
                    <input type="text" 
                           name="search" 
                           value="{{ request('search') }}"
                           placeholder="{{ __('messages.search_placeholder') ?? 'Search articles...' }}" 
                           class="w-full py-4 pl-[20%] bg-transparent border-none focus:ring-0 outline-none text-slate-600 placeholder-slate-400 transition-all">
