<x-layout title="Tirtanet - {{ config('app.name') }}" description="Layanan Internet Tirtanet">
    <!-- Custom Styles -->
    <!-- Custom Styles -->
    <style>
        html {
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-24 bg-[#eef2f6]">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            <!-- Rotating Stats -->
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-white border border-slate-200 text-indigo-600 text-sm font-bold reveal-up mb-8 shadow-sm">
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-center reveal-up delay-300">
                <a href="https://wa.me/6282229046099?text=Halo,%20saya%20ingin%20konsultasi%20mengenai%20layanan%20Tirtanet." class="px-8 py-4 font-bold text-white bg-indigo-600 rounded-2xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 group flex items-center gap-2">
    ...
    <section id="dedicated-internet" class="relative overflow-hidden py-24 bg-[#eef2f6]">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-6">Pilihan Paket Tirtanet</h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="neu-flat p-6 rounded-3xl border border-slate-200 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    <div class="mb-4 min-h-[105px]">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <span class="text-cyan-500"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg></span>
                        </div>
                    ...
                    <div class="mb-6 space-y-4">
                        <div class="min-h-[140px] flex flex-col justify-center">
                            <p class="text-xs font-bold text-cyan-600 uppercase tracking-wider mb-1">Total Bayar Awal</p>
                        ...
                        <div class="min-h-[60px] flex flex-col justify-center">
                            ...
                            <div class="text-lg font-bold text-slate-700">Rp 190.000 <span class="text-xs font-normal text-slate-400">/bln</span></div>
                    ...
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> 1 bulan dan biaya pasang</li>
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> Biaya pasang Rp 99.000</li>
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> <span id="next-payment-20mbps" class="font-bold text-slate-800">Pembayaran kembali bulan ...</span></li>
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> Biaya Layanan Rp 5.000</li>
                    </ul>
                    <div class="mt-auto border-t border-slate-100 pt-4 relative">
                        <div class="mb-4">
                            <button type="button" onclick="openModal('Keterangan Penting', [
                                'Bayar 1 atau 2 bulan dulu setelah pasang, baru normal mulai bulan berikutnya (tanggal 3–20 setiap bulannya).',
                                'Biaya bulanan FLAT tidak berubah.',
                                'Pembayaran mudah via Indomaret, Alfamart, BRILink, M-Banking, atau Virtual Account (tidak menerima pembayaran tunai ke petugas).',
                        ...
                        <a href="https://wa.me/6282229046099?text=Halo,%20saya%20berminat%20dengan%20Paket%20Termurah%2020%20Mbps." class="neu-btn block w-full py-3 rounded-xl text-center text-sm font-bold text-cyan-600 hover:text-cyan-700">Pilih Paket</a>
                    </div>
                </div>
                ...
                <div class="neu-flat p-6 rounded-3xl border border-slate-200 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300 transform md:scale-105 shadow-xl border-blue-200 relative z-10">
                    <div class="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-red-500 to-orange-500 text-white text-xs font-bold px-4 py-1 rounded-full shadow-lg">TERLARIS</div>
                    <div class="mb-4 min-h-[105px]">
                        <div class="flex justify-between items-start mb-2">
                            <span class="text-[10px] font-bold text-white bg-gradient-to-r from-cyan-500 to-blue-500 px-3 py-1 rounded-full shadow-sm">BEST SELLER</span>
                            <span class="text-blue-600"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg></span>
                        </div>
                    ...
                    <div class="mb-6 space-y-4">
                        <div class="min-h-[140px] flex flex-col justify-center">
                            <p class="text-xs font-bold text-blue-600 uppercase tracking-wider mb-1">Total Bayar Awal</p>
                        ...
                        <div class="min-h-[60px] flex flex-col justify-center">
                            <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Biaya Perbulan</p>
                            <div class="text-lg font-bold text-slate-700">Rp 230.000 <span class="text-xs font-normal text-slate-400">/bln</span></div>
                            <p class="text-[10px] text-slate-400 mt-1 italic">Harga belum termasuk PPN 11%</p>
                        </div>
                    </div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
                        <li class="flex items-start gap-2"><span class="text-blue-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> 2 bulan bayar di muka (2+1 gratis)</li>
                        <li class="flex items-start gap-2"><span class="text-blue-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> <b class="text-slate-800">Pasang GRATIS</b></li>
                        <li class="flex items-start gap-2"><span class="text-blue-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> <span id="next-payment-50mbps" class="font-bold text-slate-800">Pembayaran kembali bulan ...</span></li>
                        <li class="flex items-start gap-2"><span class="text-blue-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> Biaya Layanan Rp 5.000</li>
                    </ul>
                    <div class="mt-auto border-t border-slate-100 pt-4 relative">
                        <div class="mb-4">
                            <button type="button" onclick="openModal('Keterangan Penting', [
                        ...
                        <a href="https://wa.me/6282229046099?text=Halo,%20saya%20berminat%20dengan%20Paket%20Best%20Seller%2050%20Mbps." class="neu-btn block w-full py-3 rounded-xl text-center text-sm font-bold text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 shadow-lg shadow-blue-200">Pilih Paket</a>
                    </div>
                </div>
                ...
                <div class="neu-flat p-6 rounded-3xl border border-slate-200 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    <div class="mb-4 min-h-[105px]">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <span class="text-cyan-500"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></span>
                        </div>
                        <h3 class="text-xl font-bold text-slate-800">50 Mbps</h3>
                    ...
                    <div class="mb-6 space-y-4">
                        ...
                        <div class="min-h-[60px] flex flex-col justify-center">
                            <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Biaya Perbulan</p>
                            <div class="text-lg font-bold text-slate-700">Rp 285.000 <span class="text-xs font-normal text-slate-400">/bln</span></div>
                            <p class="text-[10px] text-slate-400 mt-1 italic">Harga belum termasuk PPN 11%</p>
                        </div>
                    </div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> Pasang dulu, aktif baru bayar</li>
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> Layanan Prioritas</li>
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> <span id="next-payment-prioritas" class="font-bold text-slate-800">Pembayaran kembali bulan ...</span></li>
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> Biaya Layanan Rp 5.000</li>
                    </ul>
                    <div class="mt-auto border-t border-slate-100 pt-4 relative">
                        <div class="mb-4">
                        ...
                        <a href="https://wa.me/6282229046099?text=Halo,%20saya%20berminat%20dengan%20Paket%20Prioritas%2050%20Mbps." class="neu-btn block w-full py-3 rounded-xl text-center text-sm font-bold text-cyan-600 hover:text-cyan-700">Pilih Paket</a>
                    </div>
                </div>
                ...
                <div class="neu-flat p-6 rounded-3xl border border-slate-200 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div class="mb-6 space-y-4">
                        ...
                        <div class="min-h-[60px] flex flex-col justify-center">
                            <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Biaya Perbulan</p>
                            <div class="text-lg font-bold text-slate-700">Rp 250.000 <span class="text-xs font-normal text-slate-400">/bln</span></div>
                            <p class="text-[10px] text-slate-400 mt-1 italic">Harga belum termasuk PPN 11%</p>
                        </div>
                    </div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> 2 bulan bayar di muka (2+1 gratis)</li>
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> <b class="text-slate-800">Pasang GRATIS</b></li>
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> <span id="next-payment-75mbps" class="font-bold text-slate-800">Pembayaran kembali bulan ...</span></li>
                        <li class="flex items-start gap-2"><span class="text-cyan-500"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg></span> Biaya Layanan Rp 5.000</li>
                    </ul>
                    <div class="mt-auto border-t border-slate-100 pt-4 relative">
                        <div class="mb-4">
                        ...
                        <a href="https://wa.me/6282229046099?text=Halo,%20saya%20berminat%20dengan%20Paket%20Cepat%2075%20Mbps." class="neu-btn block w-full py-3 rounded-xl text-center text-sm font-bold text-cyan-600 hover:text-cyan-700">Pilih Paket</a>
                    </div>
                </div>
            </div>
    ...
    <section id="eznet-wireless" class="relative py-24 bg-[#f8fafc] overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden">
            ...
            <div class="absolute -bottom-[20%] -left-[10%] w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-[120px]"></div>
        </div>

        <div class="container mx-auto px-6 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="inline-block px-4 py-1.5 rounded-full bg-cyan-500/10 text-cyan-600 text-sm font-bold tracking-wide mb-4 border border-cyan-500/20">
                    LOKASI KAMU TIDAK ADA JARINGAN?
                </span>
                <h2 class="text-3xl md:text-5xl font-bold text-slate-800 mb-6">
                    Tidak Ada Kabel Fiber? <br/> 
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600">Gunakan EZNET Wireless</span>
                </h2>
                <p class="text-slate-500 text-lg leading-relaxed">
                    Solusi internet rumah tanpa kabel fiber optic. Sistem Home Lock yang terhubung langsung dengan menara BTS Telkomsel terdekat.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
                ...
                <div class="bg-white border border-slate-200 p-8 rounded-3xl hover:border-cyan-500/50 transition-colors group shadow-sm">
                    ...
                    <a href="https://wa.me/6282229046099?text=Halo,%20saya%20berminat%20dengan%20EZNET%20Wireless%2010%20Mbps." class="block w-full py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-center rounded-xl transition-all shadow-lg shadow-blue-100">
                        Pilih Paket Ini
                    </a>
                </div>
                ...
                <div class="bg-white border border-slate-200 p-8 rounded-3xl hover:border-blue-500/50 transition-colors group shadow-sm">
                    ...
                    <a href="https://wa.me/6282229046099?text=Halo,%20saya%20berminat%20dengan%20EZNET%20Wireless%2015%20Mbps." class="block w-full py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-center rounded-xl transition-all shadow-lg shadow-blue-100">
                        Pilih Paket Ini
                    </a>
                </div>
            </div>
                ...
                <div class="bg-gradient-to-br from-cyan-50 to-blue-50 p-6 rounded-2xl border border-cyan-200 relative overflow-hidden">
                    <div class="relative z-10">
                        ...
                        <p class="text-sm text-cyan-700 leading-relaxed">
                            Pelanggan EZNET Wireless akan <b>diprioritaskan</b> untuk pendataan pembangunan jaringan fiber optic di wilayahnya dan dapat <b>upgrade ke fiber optic</b> secara prioritas saat jaringan tersedia.
                        </p>
                    </div>
                </div>
            </div>
