<x-layout description="Paket Web Bundling & Google Ads All-in-One. Solusi praktis untuk Go Online dan tingkatkan penjualan bisnis Anda.">
    ...
    <section id="comparison" class="py-24 bg-[#eef2f6]">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">{{ __('messages.wb_comparison_title') }}</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <div class="neu-flat p-8 rounded-3xl border border-white/50">
                    <div class="inline-block bg-slate-200 text-slate-600 px-4 py-1.5 rounded-full text-xs font-bold tracking-wide mb-6">{{ __('messages.wb_old_way_badge') }}</div>
                ...
                <div class="neu-flat p-8 rounded-3xl border-2 border-indigo-400">
                    <div class="inline-block bg-slate-200 text-slate-600 px-4 py-1.5 rounded-full text-xs font-bold tracking-wide mb-6">{{ __('messages.wb_new_way_badge') }}</div>
    ...
    <section class="py-24 bg-[#eef2f6]">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">{{ __('messages.wb_social_title') }}</h2>
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                ...
                <div class="neu-flat p-6 rounded-2xl border border-white/50">
                    ...
                    <p class="text-gray-700 text-base mb-5 italic leading-relaxed font-medium">{{ __('messages.wb_testi_1_text') }}</p>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold">B</div>
                        <div>
                            <div class="font-bold text-slate-800 text-sm">{{ __('messages.wb_testi_1_author') }}</div>
                ...
                <div class="neu-flat p-6 rounded-2xl border border-white/50">
                    ...
                    <p class="text-gray-700 text-base mb-5 italic leading-relaxed font-medium">{{ __('messages.wb_testi_2_text') }}</p>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 font-bold">S</div>
                        <div>
                            <div class="font-bold text-slate-800 text-sm">{{ __('messages.wb_testi_2_author') }}</div>
                ...
                <div class="neu-flat p-6 rounded-2xl border border-white/50">
                    ...
                    <p class="text-gray-700 text-base mb-5 italic leading-relaxed font-medium">{{ __('messages.wb_testi_3_text') }}</p>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600 font-bold">A</div>
                        <div>
                            <div class="font-bold text-slate-800 text-sm">{{ __('messages.wb_testi_3_author') }}</div>
                ...
                <div class="w-full md:w-1/2 order-2 md:order-1">
                    ...
                    <div class="space-y-6">
                        <div class="flex gap-3">
                            ...
                            <div>
                                <h4 class="font-bold text-slate-800 text-base mb-1">{{ __('messages.wb_value_1_title') }}</h4>
                        ...
                        <div class="flex gap-3">
                            <svg class="w-5 h-5 text-green-600 shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <div>
                                <h4 class="font-bold text-slate-800 text-base mb-1">{{ __('messages.wb_value_2_title') }}</h4>
                        ...
                        <div class="flex gap-3">
                            <svg class="w-5 h-5 text-green-600 shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            <div>
                                <h4 class="font-bold text-slate-800 text-base mb-1">{{ __('messages.wb_value_3_title') }}</h4>
                        ...
                        <div class="relative neu-flat p-6 md:p-8 rounded-[2rem] shadow-2xl border border-white/50">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-1.5">
                                            ...
                                            <span class="text-xs text-slate-500 font-medium">{{ __('messages.wb_chat_online') }}</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="flex gap-3 justify-end">
                                    <div class="bg-indigo-600 p-4 rounded-2xl rounded-tr-none max-w-[85%] text-white shadow-md shadow-indigo-200">
    ...
    <section class="py-24 bg-[#eef2f6]">
        <div class="container mx-auto px-6 max-w-4xl">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">{{ __('messages.wb_faq_title') }}</h2>
            ...
            <div class="flex flex-col gap-12">
                ...
                <div class="faq-item neu-flat rounded-2xl border border-white/50 overflow-hidden">
                    <button onclick="toggleFAQ(this)" class="w-full p-6 text-left flex items-center justify-between hover:bg-indigo-50 transition-colors">
    ...
    <section class="py-24 bg-[#eef2f6] text-center">
        <div class="container mx-auto px-6 relative z-10">
            <h2 class="text-3xl md:text-5xl font-bold text-slate-800 mb-8 leading-tight">{{ __('messages.wb_final_cta_title') }}</h2>
    ...
    <div class="sticky-cta md:hidden bg-white border-t border-slate-200 shadow-2xl p-4 left-0 right-0 w-full max-w-[100vw] overflow-x-hidden">
        <a href="https://wa.me/6282229046099?text=Halo,%20saya%20mau%20konsultasi%20tentang%20website%20dan%20Google%20Ads." class="flex items-center justify-center w-full max-w-full px-6 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-indigo-200 transition-all active:scale-95">
