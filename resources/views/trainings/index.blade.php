<x-layout title="{{ __('messages.training_title') }} - {{ config('app.name') }}" description="{{ __('messages.training_subtitle') }}">
    ...
    <section id="contact" class="py-24 bg-[#eef2f6]">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-3xl md:text-4xl font-bold mb-6 text-slate-800">{{ __('messages.training_contact_title') }}</h2>
            <p class="text-slate-500 text-lg mb-12 max-w-2xl mx-auto">
                {{ __('messages.training_contact_desc') }}
            </p>
            ...
            <div class="flex justify-center">
                ...
                <a href="https://wa.me/6282229046099" target="_blank" class="neu-btn px-8 py-4 font-bold text-indigo-600 inline-flex items-center">
                    ...
                    {{ __('messages.training_contact_btn') }}
                </a>
            </div>
        </div>
    </section>
