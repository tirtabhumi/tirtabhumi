<x-layout title="{{ __('messages.security_title') }} - {{ config('app.name') }}">
            ...
            <div class="flex flex-col md:flex-row items-center gap-16">
                ...
                <div class="w-full md:w-1/2 relative reveal-scale delay-200">
                    ...
                    <div class="relative aspect-video bg-[#eef2f6] rounded-3xl flex items-center justify-center p-4 neu-pressed overflow-hidden border border-white/50">
                        ...
                        <img src="https://images.unsplash.com/photo-1557597774-9d273605dfa9?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="CCTV Monitoring" class="absolute inset-0 w-full h-full object-cover rounded-2xl hover:scale-[1.02] transition-transform duration-700 ease-out opacity-90">
                    </div>
                </div>
            </div>
        </div>
