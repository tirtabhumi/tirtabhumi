<x-layout title="{{ __('messages.service_digital_title') }} - {{ config('app.name') }}"
    ...
    <section class="relative pt-32 pb-20 bg-[#eef2f6] overflow-hidden">
        <div class="absolute inset-0 w-full h-full">
            <div
                class="absolute top-0 right-0 w-96 h-96 bg-indigo-300/20 rounded-full blur-3xl mix-blend-multiply animate-blob">
            </div>
            <div
                class="absolute bottom-0 left-0 w-96 h-96 bg-cyan-300/20 rounded-full blur-3xl mix-blend-multiply animate-blob animation-delay-2000">
            </div>
        </div>
        <div class="container mx-auto px-6 relative z-10 text-center">
            ...
            <x-breadcrumb :paths="[__('messages.services') => '/#services']"
                :current="__('messages.service_digital_title')" />
        ...
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <a href="{{ route('webbundling') }}" class="block group">
                    <div
                        class="neu-flat p-8 rounded-3xl border border-white/50 hover:border-indigo-300 transition-all duration-300 h-full flex flex-col">
                        ...
                        <ul class="space-y-2 text-sm text-slate-600 mb-6">
                            <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-indigo-500" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7"></path>
                                </svg>{{ __('messages.digital_sub_1_list_1') }}</li>
                            <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-indigo-500" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7"></path>
                                </svg>{{ __('messages.digital_sub_1_list_2') }}</li>
                            <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-indigo-500" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7"></path>
                                </svg>{{ __('messages.digital_sub_1_list_3') }}</li>
                        </ul>
                        <div class="mt-auto pt-4 border-t border-slate-100">
                            <span
                                class="inline-flex items-center font-semibold text-indigo-600 group-hover:text-indigo-700 transition-colors">
                ...
                <!-- Automation & AI -->
                <div
                    class="neu-flat p-8 rounded-3xl border border-white/50 hover:border-indigo-300 transition-all duration-300 relative overflow-hidden">
                    ...
                    <ul class="space-y-2 text-sm text-slate-600 mb-6">
                        <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-indigo-500" fill="none"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7"></path>
                            </svg>{{ __('messages.digital_sub_2_list_1') }}</li>
                        <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-indigo-500" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7"></path>
                            </svg>{{ __('messages.digital_sub_2_list_2') }}</li>
                        <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-indigo-500" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7"></path>
                            </svg>{{ __('messages.digital_sub_2_list_3') }}</li>
                    </ul>

                    <button onclick="openAiChat()"
                        class="neu-btn w-full py-3 font-bold text-indigo-600 flex items-center justify-center gap-2">
                    ...
                    <div
                        ...
                        <ul class="space-y-2 text-sm text-slate-600 mb-6">
                            <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-indigo-500" fill="none"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7"></path>
                                </svg>{{ __('messages.digital_sub_3_list_1') }}</li>
                            <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-indigo-500" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7"></path>
                                </svg>{{ __('messages.digital_sub_3_list_2') }}</li>
                            <li class="flex items-center"><svg class="w-4 h-4 mr-2 text-indigo-500" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7"></path>
                                </svg>{{ __('messages.digital_sub_3_list_3') }}</li>
                        </ul>
                        <div class="mt-auto pt-4 border-t border-slate-100">
                            <span
                                class="inline-flex items-center font-semibold text-indigo-600 group-hover:text-indigo-700 transition-colors">
