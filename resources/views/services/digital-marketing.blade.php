<x-layout>
    ...
    <!-- Pricing Section -->
    <section id="pricing" class="py-24 bg-[#eef2f6]">
        <!-- Background Glow -->
    ...
    <div class="sticky-cta md:hidden bg-white border-t border-slate-200 shadow-2xl p-4">
        <a href="https://wa.me/6282229046099?text=Halo,%20saya%20mau%20konsultasi%20Digital%20Marketing." class="flex items-center justify-center w-full px-6 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-indigo-200 transition-all active:scale-95">
