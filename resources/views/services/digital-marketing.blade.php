<x-layout>
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div class="relative container mx-auto px-6 text-center z-10">
            ...
            <div class="flex flex-col md:flex-row gap-6 justify-center">
                <a href="https://wa.me/6282229046099?text=Halo,%20saya%20tertarik%20dengan%20jasa%20Digital%20Marketing." class="px-8 py-4 neu-btn font-bold text-indigo-600">
                    {{ __('messages.contact_us') }}
                </a>
                <a href="#pricing" class="px-8 py-4 neu-flat hover:shadow-none transition-all text-slate-600 rounded-full font-medium border border-slate-200/50">
                    Lihat Paket
                </a>
            </div>
        </div>
    ...
    <section id="pricing" class="relative overflow-hidden py-24 bg-[#eef2f6]">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="text-center mb-16">
                ...
                <p class="text-slate-500 text-lg">Pilih solusi yang paling sesuai dengan kebutuhan bisnis Anda.</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
                ...
                <div class="neu-flat border border-white/50 rounded-3xl p-8 hover:-translate-y-1 transition-all">
                    ...
                    <ul class="space-y-4 mb-8 text-slate-700 text-sm">
                        <li class="flex gap-3"><span class="text-green-600 font-bold">✓</span> {{ __('messages.dm_pkg_1_feat_1') }}</li>
                        <li class="flex gap-3"><span class="text-green-600 font-bold">✓</span> {{ __('messages.dm_pkg_1_feat_2') }}</li>
                        <li class="flex gap-3"><span class="text-green-600 font-bold">✓</span> {{ __('messages.dm_pkg_1_feat_3') }}</li>
                    </ul>
                    <a href="https://wa.me/6282229046099?text=Info%20Paket%20Basic%20Ads" class="block w-full py-4 rounded-xl neu-flat hover:neu-pressed text-slate-700 text-center transition-all font-medium">{{ __('messages.contact_us') }}</a>
                </div>
                ...
                <div class="neu-flat rounded-3xl p-8 relative transform md:scale-110 shadow-2xl z-10 border-2 border-indigo-500">
                    ...
                    <ul class="space-y-5 mb-10 text-slate-700 text-sm font-medium">
                        <li class="flex gap-3 items-center"><span class="text-indigo-600 font-bold">✓</span> <strong>{{ __('messages.dm_pkg_2_feat_1') }}</strong></li>
                        <li class="flex gap-3 items-center"><span class="text-indigo-600 font-bold">✓</span> <strong>{{ __('messages.dm_pkg_2_feat_2') }}</strong></li>
                        <li class="flex gap-3 items-center"><span class="text-indigo-600 font-bold">✓</span> {{ __('messages.dm_pkg_2_feat_3') }}</li>
                    </ul>
                    <a href="https://wa.me/6282229046099?text=Info%20Paket%20Strategic%20Ads" class="block w-full py-4 rounded-xl neu-flat hover:neu-pressed text-indigo-700 font-bold text-center transition-all">{{ __('messages.contact_us') }}</a>
                </div>
                ...
                <div class="neu-flat border border-white/50 rounded-3xl p-8 hover:-translate-y-1 transition-all">
                    ...
                    <ul class="space-y-4 mb-8 text-slate-700 text-sm">
                        <li class="flex gap-3"><span class="text-green-600 font-bold">✓</span> {{ __('messages.dm_pkg_3_feat_1') }}</li>
                        <li class="flex gap-3"><span class="text-green-600 font-bold">✓</span> {{ __('messages.dm_pkg_3_feat_2') }}</li>
                        <li class="flex gap-3"><span class="text-green-600 font-bold">✓</span> {{ __('messages.dm_pkg_3_feat_3') }}</li>
                    </ul>
                    <a href="https://wa.me/6282229046099?text=Info%20Paket%20Comprehensive%20Growth" class="block w-full py-4 rounded-xl neu-flat hover:neu-pressed text-slate-700 text-center transition-all font-medium">{{ __('messages.contact_us') }}</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">{{ __('messages.dm_testi_title') }}</h2>
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                ...
                <div class="neu-flat p-6 rounded-2xl border border-slate-100">
                    ...
                    <p class="text-gray-700 text-base mb-5 italic leading-relaxed font-medium">{{ __('messages.dm_testi_1_text') }}</p>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold">S</div>
                        <div>
                            <div class="font-bold text-slate-800 text-sm">{{ __('messages.dm_testi_1_author') }}</div>
                ...
                <div class="neu-flat p-6 rounded-2xl border border-slate-100">
                    ...
                    <p class="text-gray-700 text-base mb-5 italic leading-relaxed font-medium">{{ __('messages.dm_testi_2_text') }}</p>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 font-bold">B</div>
                        <div>
                            <div class="font-bold text-slate-800 text-sm">{{ __('messages.dm_testi_2_author') }}</div>
                ...
                <div class="neu-flat p-6 rounded-2xl border border-slate-100">
                    ...
                    <p class="text-gray-700 text-base mb-5 italic leading-relaxed font-medium">{{ __('messages.dm_testi_3_text') }}</p>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600 font-bold">D</div>
                        <div>
                            <div class="font-bold text-slate-800 text-sm">{{ __('messages.dm_testi_3_author') }}</div>
    ...
    <section class="py-24 bg-[#eef2f6] text-center">
        <div class="container mx-auto px-6 relative z-10">
            <h2 class="text-3xl md:text-5xl font-bold text-slate-800 mb-8 leading-tight">{{ __('messages.footer_cta_title') }}</h2>
            <p class="text-slate-500 text-lg mb-12 max-w-2xl mx-auto">{{ __('messages.footer_cta_desc') }}</p>
            <a href="https://wa.me/6282229046099?text=Halo,%20saya%20mau%20konsultasi%20Digital%20Marketing." class="px-8 py-4 neu-btn font-bold text-indigo-600 inline-flex items-center justify-center">
    ...
    <!-- Sticky Mobile CTA -->
    <div class="sticky-cta md:hidden bg-white border-t border-slate-200 shadow-2xl p-4 left-0 right-0 w-full max-w-[100vw] overflow-x-hidden">
        <a href="https://wa.me/6282229046099?text=Halo,%20saya%20mau%20konsultasi%20Digital%20Marketing." class="flex items-center justify-center w-full max-w-full px-6 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-indigo-200 transition-all active:scale-95">
