        ...
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div id="grid-basic" class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="neu-flat p-6 rounded-3xl border border-white/50 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div class="mb-6"><div class="text-3xl font-extrabold text-slate-800">Rp 1.787.500<span class="text-sm font-normal text-slate-500">{{ __('messages.network_managed_per_month') }}</span></div><div class="text-xs text-slate-400 mt-1">{{ __('messages.network_managed_total_contract') }} Rp 64.350.000</div><div class="text-xs text-slate-400">{{ __('messages.network_managed_vat_excluded') }}</div></div>
                ...
                <div class="neu-flat p-6 rounded-3xl border border-white/50 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div class="mb-6"><div class="text-3xl font-extrabold text-slate-800">Rp 2.530.710 <span class="text-sm font-normal text-slate-500">{{ __('messages.network_managed_per_month') }}</span></div><div class="text-xs text-slate-400 mt-1">{{ __('messages.network_managed_total_contract') }} Rp 91.105.560</div><div class="text-xs text-slate-400">{{ __('messages.network_managed_vat_excluded') }}</div></div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
                ...
                <div class="neu-flat p-6 rounded-3xl border border-white/50 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div class="mb-6"><div class="text-3xl font-extrabold text-slate-800">Rp 3.084.770 <span class="text-sm font-normal text-slate-500">{{ __('messages.network_managed_per_month') }}</span></div><div class="text-xs text-slate-400 mt-1">{{ __('messages.network_managed_total_contract') }} Rp 111.051.720</div><div class="text-xs text-slate-400">{{ __('messages.network_managed_vat_excluded') }}</div></div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
                ...
                <div class="neu-flat p-6 rounded-3xl border border-white/50 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div class="mb-6"><div class="text-3xl font-extrabold text-slate-800">Rp 3.924.700 <span class="text-sm font-normal text-slate-500">{{ __('messages.network_managed_per_month') }}</span></div><div class="text-xs text-slate-400 mt-1">{{ __('messages.network_managed_total_contract') }} Rp 141.289.200</div><div class="text-xs text-slate-400">{{ __('messages.network_managed_vat_excluded') }}</div></div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
            ...
            <div id="grid-premium" class="hidden grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="neu-flat p-6 rounded-3xl border border-white/50 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div class="mb-6"><div class="text-3xl font-extrabold text-slate-800">Rp 1.651.000<span class="text-sm font-normal text-slate-500">{{ __('messages.network_managed_per_month') }}</span></div><div class="text-xs text-slate-400 mt-1">{{ __('messages.network_managed_total_contract') }} Rp 59.436.000</div><div class="text-xs text-slate-400">{{ __('messages.network_managed_vat_excluded') }}</div></div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
                ...
                <div class="neu-flat p-6 rounded-3xl border border-white/50 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div class="mb-6"><div class="text-3xl font-extrabold text-slate-800">Rp 2.601.040<span class="text-sm font-normal text-slate-500">{{ __('messages.network_managed_per_month') }}</span></div><div class="text-xs text-slate-400 mt-1">{{ __('messages.network_managed_total_contract') }} Rp 93.637.440</div><div class="text-xs text-slate-400">{{ __('messages.network_managed_vat_excluded') }}</div></div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
                ...
                <div class="neu-flat p-6 rounded-3xl border border-white/50 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div class="mb-6"><div class="text-3xl font-extrabold text-slate-800">Rp 3.123.250 <span class="text-sm font-normal text-slate-500">{{ __('messages.network_managed_per_month') }}</span></div><div class="text-xs text-slate-400 mt-1">{{ __('messages.network_managed_total_contract') }} Rp 112.437.000</div><div class="text-xs text-slate-400">{{ __('messages.network_managed_vat_excluded') }}</div></div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
                ...
                <div class="neu-flat p-6 rounded-3xl border border-white/50 flex flex-col h-full hover:-translate-y-2 transition-transform duration-300 transform md:scale-105 shadow-xl border-indigo-200">
                    ...
                    <div class="mb-6"><div class="text-3xl font-extrabold text-slate-800">Rp 3.963.310 <span class="text-sm font-normal text-slate-500">{{ __('messages.network_managed_per_month') }}</span></div><div class="text-xs text-slate-400 mt-1">{{ __('messages.network_managed_total_contract') }} Rp 142.679.160</div><div class="text-xs text-slate-400">{{ __('messages.network_managed_vat_excluded') }}</div></div>
                    <ul class="space-y-3 text-sm text-slate-600 mb-8 flex-grow">
