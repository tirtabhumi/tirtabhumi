...
<head>
    ...
    })(window,document,'script','dataLayer','GTM-PJ9GZ5CT');</script>
    <!-- End Google Tag Manager -->
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-HD40Z9KRKN"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-HD40Z9KRKN');
    </script>
    <meta charset="utf-8">
...
<body class="antialiased selection:bg-indigo-500 selection:text-white">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PJ9GZ5CT"
                ...
                <div class="grid md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-slate-500">
                            ...
                            <li><a href="https://www.facebook.com/tirtabhumiid/" target="_blank" rel="noopener noreferrer" class="hover:text-indigo-600 transition-all hover:translate-x-1 inline-block">Facebook</a></li>
                            ...
                            <li><a href="mailto:hello@tirtabhumi.com" class="hover:text-indigo-600 transition-all hover:translate-x-1 inline-block">hello@tirtabhumi.com</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="flex flex-col text-center">
                    ...
                    <div class="border-b border-slate-100">
                        ...
                        <div id="mobile-services-menu" class="hidden flex-col space-y-2 pb-4">
                            ...
                            <a href="{{ route('trainings.index') }}" class="text-base text-slate-500 hover:text-indigo-600 py-2 block">{{ __('messages.service_people_title') }}</a>
                    ...
                    <div class="mt-auto pt-8 pb-8">
                        <div class="flex gap-4 justify-center">
                            <!-- Instagram -->
                            <a href="https://www.instagram.com/tirtabhumi.id/" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-slate-300 flex items-center justify-center text-slate-600 hover:border-indigo-600 hover:text-indigo-600 transition-all hover:-translate-y-1 hover:shadow-md">
                            ...
                            <!-- Facebook -->
                            <a href="https://www.facebook.com/tirtabhumiid/" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-slate-300 flex items-center justify-center text-slate-600 hover:border-indigo-600 hover:text-indigo-600 transition-all hover:-translate-y-1 hover:shadow-md">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                                </svg>
                            </a>
                            <!-- LinkedIn -->
                            <a href="https://linkedin.com/company/pt-tirta-bhumi-indonesia" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-slate-300 flex items-center justify-center text-slate-600 hover:border-indigo-600 hover:text-indigo-600 transition-all hover:-translate-y-1 hover:shadow-md">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill-rule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clip-rule="evenodd" />
                                </svg>
                            </a>
                            <!-- WhatsApp -->
                            <a href="https://wa.me/6282229046099" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-slate-300 flex items-center justify-center text-slate-600 hover:border-indigo-600 hover:text-indigo-600 transition-all hover:-translate-y-1 hover:shadow-md">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <!-- Email -->
                            <a href="mailto:hello@tirtabhumi.com" class="w-10 h-10 rounded-full border border-slate-300 flex items-center justify-center text-slate-600 hover:border-indigo-600 hover:text-indigo-600 transition-all hover:-translate-y-1 hover:shadow-md">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
