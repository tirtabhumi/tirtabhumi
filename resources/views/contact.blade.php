                ...
                <div class="grid md:grid-cols-2 gap-16 md:gap-12 lg:gap-24 items-start">
                    ...
                    <div class="animate-fade-in-up animation-delay-200">
                        ...
                        <div class="mt-12 flex flex-col gap-12">
                            <a href="https://wa.me/6282229046099" target="_blank" class="neu-btn w-full px-8 py-4 flex items-center justify-center gap-2 text-green-600 font-bold hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 group">
                            ...
                            <a href="mailto:hello@tirtabhumi.com" class="neu-btn w-full px-8 py-4 flex items-center justify-center gap-2 text-indigo-600 font-bold hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 group">
