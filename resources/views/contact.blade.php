<x-layout>
    ...
    <!-- Header Section -->
    <section class="relative py-24 bg-[#eef2f6] overflow-hidden">
        <!-- Background Blobs -->
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-slate-800 mb-6 animate-fade-in-up">{{ __('messages.contact_us') }}</h1>
            <p class="text-lg text-slate-500 max-w-2xl mx-auto animate-fade-in-up animation-delay-100">
    ...
    <section class="py-24 bg-[#eef2f6] relative overflow-hidden">
        <!-- Background Blobs for Content Section -->
        <div class="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
             <div class="absolute bottom-0 left-0 w-96 h-96 bg-blue-300/20 rounded-full blur-3xl mix-blend-multiply animate-blob animation-delay-2000"></div>
             <div class="absolute top-1/2 right-0 w-96 h-96 bg-pink-300/20 rounded-full blur-3xl mix-blend-multiply animate-blob animation-delay-4000"></div>
        </div>

            <!-- Unified Container -->
            <div class="neu-flat p-8 md:p-12 rounded-[2.5rem] border border-white/50 relative overflow-hidden">
                <div class="grid md:grid-cols-2 gap-16 md:gap-12 lg:gap-24 items-start">
                    <!-- Contact Info -->
                    <div class="animate-fade-in-up animation-delay-200">
                        <h3 class="text-2xl font-bold text-slate-800 mb-10">{{ __('messages.connect') }}</h3>
                        
                        <div class="space-y-10">
                            <!-- Address -->
                            <div class="flex items-start gap-4">
                                <div class="w-12 h-12 shrink-0 neu-pressed rounded-xl flex items-center justify-center text-indigo-600">
                        ...
                        <div class="mt-12 flex flex-col gap-6">
                            <a href="https://wa.me/6282229046099" target="_blank" class="neu-btn w-full px-6 py-4 rounded-xl flex items-center justify-center gap-2 text-green-600 font-bold hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 group">
                            ...
                            <a href="mailto:hello@tirtabhumi.com" class="neu-btn w-full px-6 py-4 rounded-xl flex items-center justify-center gap-2 text-indigo-600 font-bold hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 group">
                    ...
                    <div class="animate-fade-in-up animation-delay-300">
                        <h3 class="text-2xl font-bold text-slate-800 mb-10">{{ __('messages.contact_form_title') }}</h3>
                    ...
                    <form action="{{ route('contacts.store') }}" method="POST" class="space-y-8">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" class="w-full px-4 py-3 rounded-xl neu-pressed border-none focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all" placeholder="{{ __('messages.contact_name_placeholder') }}">
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-bold text-slate-700 mb-2">{{ __('messages.contact_email_label') }}</label>
                            <input type="email" id="email" name="email" class="w-full px-4 py-3 rounded-xl neu-pressed border-none focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all" placeholder="{{ __('messages.contact_email_placeholder') }}">
                        </div>
                        <div>
                            <label for="subject" class="block text-sm font-bold text-slate-700 mb-2">{{ __('messages.contact_subject') }}</label>
                            <input type="text" id="subject" name="subject" class="w-full px-4 py-3 rounded-xl neu-pressed border-none focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all" placeholder="{{ __('messages.contact_subject_placeholder') }}">
                        </div>
                        <div>
                            <label for="message" class="block text-sm font-bold text-slate-700 mb-2">{{ __('messages.contact_message') }}</label>
                            <textarea id="message" name="message" rows="4" class="w-full px-4 py-3 rounded-xl neu-pressed border-none focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all" placeholder="{{ __('messages.contact_message_placeholder') }}"></textarea>
                        </div>
