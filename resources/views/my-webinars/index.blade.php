<x-layout-upventure title="My Webinars - Learning Dashboard">
    <style>
        ...
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div class="text-center mb-16 animate-fade-in-up">
                ...
                <p class="text-slate-500 text-lg max-w-2xl mx-auto">
                    Access your purchased webinars and continue your learning journey
                </p>
            </div>
            ...
            <div class="flex flex-col lg:flex-row gap-8 animate-fade-in-up" style="animation-delay: 200ms">
                ...
                <div class="w-full lg:w-[20%] sidebar-width">
                    <div class="sticky top-24">
                        <form action="{{ route('my-webinars.index') }}" method="GET" id="filterForm">
                            ...
                            <div class="neu-flat rounded-3xl p-8 border border-white/50">
                                <div class="mb-6 flex items-center justify-between">
                                    ...
                                    <a href="{{ route('my-webinars.index') }}" class="text-xs text-red-500 font-bold hover:underline">Reset</a>
                                </div>
                                ...
                                <div>
                                    <button type="button" class="flex items-center justify-between w-full mb-3 group" onclick="document.getElementById('type-list').classList.toggle('hidden')">
                                        <h4 class="font-bold text-slate-800 group-hover:text-indigo-600 transition-colors">Lokasi</h4>
                ...
                <div class="w-full lg:w-[80%] content-width">
                    <div class="mb-8">
                        <div class="mb-6">
                            <h2 class="text-2xl font-bold text-slate-800 mb-1">Daftar Webinar</h2>
                            <p class="text-slate-500 text-sm">{{ $myWebinars->total() }} webinar tersedia</p>
                        </div>
                        <div class="w-full">
                            <form action="{{ route('my-webinars.index') }}" method="GET" class="relative w-full flex items-center rounded-full neu-pressed bg-[#eef2f6] px-6 transition-all hover:shadow-md">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        @forelse($myWebinars as $registration)
                            @php
                                // Calculate progress for this webinar
                            ...
                            <div class="neu-flat rounded-2xl overflow-hidden border border-white/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group flex flex-col h-full relative">
                                <a href="{{ route('my-webinars.show', $registration->training_id) }}" class="absolute inset-0 z-10"><span class="sr-only">Lihat Detail Kelas</span></a>
                        ...
                        @empty
                            <div class="col-span-full">
                                <div class="neu-flat rounded-3xl p-16 text-center border border-white/50">
                                    ...
                                    <h3 class="text-2xl font-bold text-slate-700 mb-3">Tidak Ada Webinar</h3>
                                    <p class="text-slate-500 mb-8 max-w-md mx-auto">Tidak ada webinar yang sesuai dengan filter Anda</p>
                                    <a href="{{ route('my-webinars.index') }}" class="neu-btn px-8 py-4 font-bold text-indigo-600 inline-block">
                                        Reset Filter
                                    </a>
                                </div>
                            </div>
                    ...
                    <!-- Pagination -->
                    @if($myWebinars->hasPages())
                        <div class="mt-12">
                            {{ $myWebinars->links('components.pagination') }}
                        </div>
                    @endif
                </div>
            </div>
