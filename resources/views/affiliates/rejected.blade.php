        ...
        <div class="container mx-auto px-6 relative z-10 max-w-2xl">
            <div class="neu-flat p-12 rounded-3xl border border-white/50 text-center animate-fade-in-up">
                ...
                <p class="text-lg text-slate-600 mb-6 leading-relaxed">
                    Mohon maaf, pendaftaran Anda sebagai <strong>UpVenture Affiliate</strong> tidak dapat disetujui.
                </p>
                ...
                <div
                    ...
                    <ul class="space-y-2 text-sm text-slate-700">
                        <li class="flex gap-2">
                            ...
                            <span>Periksa kembali dokumen yang Anda upload</span>
                        </li>
                        <li class="flex gap-2">
                            <svg class="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            <span>Pastikan nama di KTP dan rekening bank sama</span>
                        </li>
                        <li class="flex gap-2">
                            <svg class="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            <span>Hubungi customer service untuk informasi lebih lanjut</span>
                        </li>
                    </ul>
                </div>
